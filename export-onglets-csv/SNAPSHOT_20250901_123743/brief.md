# Snapshot: SNAPSHOT_20250901_123743

- Genere le: 2025-09-01T12:39:30Z
- CSV: 48 fichiers
- Projets GAS concatenes: 4

## Google Sheets
- BDD_V2_Tests_Profils_1m2MGB (onglets: 38, lignes: 1876) - id_hint: BDD_V2_Tests_Profils_1m2MGB
  ...
  - ex_Questions_Couleurs_EN: 40 lignes, 7 colonnes - BDD_V2_Tests_Profils_1m2MGB\ex_Questions_Couleurs_EN.csv
    - colonnes: ID, TypeQuestion, Titre, Options, Logique, Description, ParamÃ¨tres (JSON)
...
- CONFIG_V2_Usine_Tests_1kLBqI (onglets: 8, lignes: 109) - id_hint: CONFIG_V2_Usine_Tests_1kLBqI
  ...
  - Param_tres_G_n_raux: 5 lignes, 37 colonnes - CONFIG_V2_Usine_Tests_1kLBqI\Param_tres_G_n_raux.csv
  ...
  - sys_Options_Parametres: 9 lignes, 11 colonnes - CONFIG_V2_Usine_Tests_1kLBqI\sys_Options_Parametres.csv
...
- scripts__MOTEUR_V2_Usine_à_Tests.txt - 1234 lignes
...
- scripts__TEMPLATE_V2_Kit_de_Traitement.txt - 2422 lignes
  - fonctions: readFilesRecursively, DBG, _spyDumpRow_, _spyFindNomEmail_, _nettoyerEnTete, _sheetLooksLikeResponses_, ok, _pickSheetByNameOrHeuristic_, _getReponsesSheet_, sys, tryOpenById, _creerObjetReponse, config, genererPdfDepuisModele, normalizeAndDedupeCompositionEmailsRows_, _enrichirDonneesPourEmail_, onFormSubmit, _envoyerEmailDeConfirmation, traiterLigne, assemblerEtEnvoyerEmailUniversel
