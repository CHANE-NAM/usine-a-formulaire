...
> Généré automatiquement depuis **scripts__BIBLIOTHEQUE_TEMPLATE.txt** — snapshot: **SNAPSHOT_20250914_043957**.
...
function ui_ConfigResponsesSheet() {
  ...
  const msg = 'Colle ici lâ€™ID du *classeur de rÃ©ponses* liÃ© au Google Form.';
